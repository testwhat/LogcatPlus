...
public final class FileListingService {
    ...
    public static final class FileEntry {
         ...
         */
        private static final Comparator<FileEntry> sEntryComparator = new Comparator<FileEntry>() {
            @Override
        ...
        Thread t = new Thread("ls " + entry.getFullPath()) { //$NON-NLS-1$
            ...
            public void run() {
                ...
                if (children.length > 0 && children[0].isApplicationPackage()) {
                    final HashMap<String, FileEntry> map = new HashMap<>();
    ...
    private void doLsAndThrow(FileEntry entry) throws TimeoutException,
        ...
        ArrayList<FileEntry> entryList = new ArrayList<>();
