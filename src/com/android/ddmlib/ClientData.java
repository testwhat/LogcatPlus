...
public class ClientData {
    ...
    */
    ...
    private final TreeMap<Integer,ThreadInfo> mThreadMap;
    ...
    private final HashMap<Integer, HeapInfo> mHeapInfoMap = new HashMap<>();

    /** library map info. Stored here since the backtrace data
     * is computed on a need to display basis.
     */
    private final ArrayList<NativeLibraryMapInfo> mNativeLibMapInfo =
        new ArrayList<>();

    /** Native Alloc info list */
    private final ArrayList<NativeAllocationInfo> mNativeAllocationList =
        new ArrayList<>();
